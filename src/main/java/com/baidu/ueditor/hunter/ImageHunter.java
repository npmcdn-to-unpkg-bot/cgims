...
public class ImageHunter {
	...
	public IAliyunOSSService getAossService() {
		return aossService;
	}

	public void setAossService(IAliyunOSSService aossService) {
		this.aossService = aossService;
	}
...
//
//			// 初始化OSSClient
//		    OSSClient client = aossService.getOSSClient();
//
//		    // 获取指定文件的输入流
...
//
//			String path = Constants.ALIYUN_OSS_UPLOAD_HEAD_URL+Constants.ALIYUN_OSS_UPLOAD_IMAGE_URL+aossService.getAutoBuildDirectory()+suffix;
//			
