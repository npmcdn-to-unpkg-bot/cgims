...
public class Uploader {
	...
	if (multipartResolver.isMultipart(request)) {
		...
		if (file != null) {
			...
			this.url = this.getFolder(this.savePath) + "/"
				+ this.fileName;
//			System.out.println(myFileName);
			...
			// 定义上传路径
			String path = "C:\\Users\\Administrator\\Desktop\\test\\img_test\\"
				+ fileName;
//			System.out
//				.println(this.getPhysicalPath(this
//					.getFolder(this.savePath)
//					+ "/"
//					+ this.fileName));
			System.out.println("url:"+this.url);
			path = this.getPhysicalPath(this.url);
...
//	System.out.println(path+"_"+servletPath+"_"+realPath);
//	return new File(realPath).getParent() + "/" + path;
	return this.request.getSession().getServletContext()
		.getRealPath("/")+"/assets/"+path;
    }
