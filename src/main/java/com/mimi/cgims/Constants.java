...
public class Constants {
    ...
    public static final String[][] ROLE_PERMISSIONS = {{PERMISSION_CODE_ROLE_MANAGER, PERMISSION_CODE_USER_MANAGER, PERMISSION_CODE_ORDER_MANAGER,PERMISSION_CODE_ORDER_VIEW,PERMISSION_CODE_USER_ORDER_MANAGER, PERMISSION_CODE_WORKMAN_MANAGER, PERMISSION_CODE_ANALYSIS_MANAGER},
    ...
    public static final String[] PERSON_ORDER_STATUS_VIEW = {ORDER_STATUS_WSWF, ORDER_STATUS_YSWF, ORDER_STATUS_WSWW, ORDER_STATUS_WSWC, ORDER_STATUS_YSWW};
    public static final String[] PERSON_ORDER_STATUS_OPERATION = {ORDER_STATUS_WSWF, ORDER_STATUS_WSXF, ORDER_STATUS_YSWF, ORDER_STATUS_YSXF, ORDER_STATUS_WSSB, ORDER_STATUS_YSDT, ORDER_STATUS_WSWW, ORDER_STATUS_WSWC, ORDER_STATUS_YSWW};
