...
public class Constants {
    ...
    public static final String[] PERSON_ORDER_STATUS_OPERATION = {ORDER_STATUS_WSWF, ORDER_STATUS_WSXF, ORDER_STATUS_YSWF, ORDER_STATUS_YSXF, ORDER_STATUS_WSSB, ORDER_STATUS_YSDT};
