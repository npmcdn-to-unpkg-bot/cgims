...
<c:set var="commonHeadUrl" value="${parentHeadUrl }/designImage/update"/>
...
<html>
	...
	<script type="text/javascript">
		...
		var designImageContentUploadUrl = "${ctx}/mi${commonHeadUrl}/uploadContent";
		var saveDesignImageUrl = "${ctx}/mi${commonHeadUrl}/json";

		var getImageViewUrl = "${ctx}/mi${commonHeadUrl}/view/json/${id}";
