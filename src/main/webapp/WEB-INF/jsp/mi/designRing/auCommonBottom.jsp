<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
		...
		$("#imageFile").change(function(){
		    ...
		    $.ajax({
		        type:'POST',
		        url:designRingPreViewUploadUrl,
		        data: formData,
		        async: true,
		        cache: false,
				dataType : "json",
		...
		$("#contentFile").change(function(){
		    ...
		    $.ajax({
		        type:'POST',
		        url:designRingContentUploadUrl,
		        data: formData,
		        async: true,
		        cache: false,
				dataType : "json",
		...
		$("#submit").click(function(){
			...
			if(res){
				var ring = getRingData();	
//				if(!ring.housePlanUrl){
...
//				}	
			...
			btn.addClass("disabled");
			   $.ajax({
			   	type:"POST",
			   	url:saveDesignRingUrl,
			   	async:true,
// 			   	data:$.extend(ring,{"realEstateProjectId":"${realEstateProjectId}"),
// 			   	data:ring,
			   	data:$.extend(ring,{"newProductIds":newProductIds}),
			   	dataType:"json",
			   	success:function(data){
			   		if(data){
			   			if(!data.success){
