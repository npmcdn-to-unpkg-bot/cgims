...
<c:set var="commonHeadUrl" value="${parentHeadUrl }/designRing/update"/>
...
<html>
	...
	<script type="text/javascript">
		...
		var designRingPreViewUploadUrl = "${ctx}/mi${commonHeadUrl}/uploadPreView";
		var designRingContentUploadUrl = "${ctx}/mi${commonHeadUrl}/uploadContent";
		var saveDesignRingUrl = "${ctx}/mi${commonHeadUrl}/json";

		var getRingViewUrl = "${ctx}/mi${commonHeadUrl}/view/json/${id}";
