...
<c:set var="commonHeadUrl" value="${parentHeadUrl }/relationship/view"/>
...
<html>
	...
	<script type="text/javascript">
		...
		<c:if test="${parentHeadUrl!='' }">
			goBackUrl = "${ctx}/mi${parentHeadUrl}/${tableId}";
		</c:if>

		var getRelationshipViewUrl = "${ctx}/mi/relationship/view/json/${id}";
		
	</script>
	<%@include file="commonBottom.jsp" %>
	<%@include file="uvCommonBottom.jsp" %>
	<script>
		openCloseRelationshipDetail("js-relationship-detail-container");
	</script>
</html>