...
<div class="workmanSelfMain">
    ...
    <div class="line">
        <div class="serviceItem">
            <span class="tTitle">服务类型</span>
            <div class="checkBoxForm">
                <input type="checkbox" id="allCB"/><label for="psazCB">全部</label>
            </div>
            <div class="checkBoxForm">
        ...
        <div class="serviceItem">
            <span class="tTitle">家具类</span>
            <div class="checkBoxForm">
                <input type="checkbox" id="alljjCB"/><label for="alljjCB">全部</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="myjjCB"/><label for="myjjCB">民用家具</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="bgjjCB"/><label for="bgjjCB">办公家具</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="dzjjCB"/><label for="dzjjCB">定制家具（衣橱类）</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="qtjjCB"/><label for="qtjjCB">其他</label><input type="text"/>
            </div>
        </div>
        <div class="serviceItem">
            <span class="tTitle">灯具类</span>
            <div class="checkBoxForm">
                <input type="checkbox" id="alldjCB"/><label for="alldjCB">全部</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="djazCB"/><label for="djazCB">灯具安装</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="djjcwxCB"/><label for="djjcwxCB">灯具检测维修</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="dljcwxCB"/><label for="dljcwxCB">电路检测维修</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="djCB"/><label for="djCB">其他</label><input type="text"/>
            </div>
        </div>

        <div class="serviceItem">
            <span class="tTitle">卫浴类</span>
            <div class="checkBoxForm">
                <input type="checkbox" id="alldjCB"/><label for="alldjCB">全部</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="djazCB"/><label for="djazCB">马桶</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="djjcwxCB"/><label for="djjcwxCB">花洒</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="dljcwxCB"/><label for="dljcwxCB">淋浴屏</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="dljcwxCB"/><label for="dljcwxCB">浴室柜</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="dljcwxCB"/><label for="dljcwxCB">水龙头</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="dljcwxCB"/><label for="dljcwxCB">储物架</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="dljcwxCB"/><label for="dljcwxCB">水盆类</label>
            </div>
            <div class="checkBoxForm">
                <input type="checkbox" id="djCB"/><label for="djCB">其他</label><input type="text"/>
            </div>
